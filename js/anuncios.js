...
httpUtil(book_id.trim());

loader.style.display = "none";

function httpUtil(id) {

    var book_capa, book_author, comments, book, badge_type, badge_condition, spl_tag;

    var url = ANYBOOK_API + 'anuncios?book_id=' + id ;
    ...
    for (let i = 0; i < obj.length; i++) {
        ...
        book_author = (book.authors !== undefined) ? book.authors: "";
